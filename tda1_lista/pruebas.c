...
void lista_quitar_saca_el_elemento_y_disminuye_cantidad()
{
        ...
        pa2m_afirmar(lista_ultimo(lista) == &d, "El ultimo elemento se apunta correctamente");
        ...
        valor_quitado = lista_quitar_de_posicion(lista, 0);
        pa2m_afirmar(valor_quitado == &d, "Se puede quitar elemento de posición 0 correctamente");
        pa2m_afirmar(lista_primero(lista) == NULL, "El nodo inicio de una lista liberada es NULL");
